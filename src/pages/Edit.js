...
import { editJob } from "../redux/modules/feedSlice";
...
function Edit() {
  ...
  const [file, setFile] = useState(job.thumbnail);
  ...
  const [selectedFile, setSelectedFile] = useState(job.thumbnail);
  ...
  return (
    <div className="newjob-container">
      <div className="detailhead topmg40">채용공고 수정하기</div>
      ...
      <input 
      type="text" 
      className="newjob-input topmg10" 
      ref={_title}
      ...
      <textarea 
      className="newjob-inputarea" 
      ref={_maincontent}
      defaultValue={job.maincontent}
      ></textarea>
      <div className="newjob-head">자격요건</div>
      <textarea 
      className="newjob-inputarea" 
      ref={_subcontent}
      defaultValue={job.subcontent}
      ></textarea>
